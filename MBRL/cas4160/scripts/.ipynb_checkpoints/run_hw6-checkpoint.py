...
import yaml
from cas4160 import envs

from cas4160.agents.model_based_agent import ModelBasedAgent
...
from cas4160.envs import register_envs
...
def run_training_loop(
    ...
    for itr in range(config["num_iters"]):
        ...
        for _ in tqdm.trange(
            ...
            acs_batch = batch["actions"]
            next_obs_batch = batch["next_observations"]
                          
            for i in range(mb_agent.ensemble_size):
                loss_i = mb_agent.get_loss(i, obs_batch, acs_batch, next_obs_batch)
